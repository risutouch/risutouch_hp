...
<div class="tab-content active">
    ...
    <div class="security-section">
        ...
        <div class="email-settings">
            <h4>現在の設定</h4>
            <p><strong>システム送信元メール:</strong> <?php echo htmlspecialchars($SYSTEM_FROM_EMAIL ?? 'info@risutouch.com'); ?></p>
            <p><strong>管理者認証用メール:</strong> <?php echo htmlspecialchars($ADMIN_LOGIN_EMAIL ?? $ADMIN_EMAIL); ?></p>
            <p><strong>認証コード有効期限:</strong> 10分間</p>
            <div class="alert alert-info" style="margin-top: 10px;">
                <small>
                    <strong>📧 メール設定について:</strong><br>
                    • システム送信元: 認証メール等の送信に使用（ConoHa SMTP）<br>
                    • 管理者認証用: ログイン時の認証先メールアドレス<br>
                    • お客様向け連絡先: ウェブサイト表示用（基本設定で変更可能）
                </small>
            </div>
